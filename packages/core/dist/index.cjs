...
function useArrowNavigation({
  ...
  const focusElement = React.useCallback((index) => {
  ...
  ({
    ...
    const getTabItems = () => {
      ...
      React__default.default.Children.forEach(children, (child) => {
        if (React__default.default.isValidElement(child) && child.type === DynTab) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "dyn-tabs__content", children: React__default.default.Children.map(children, (child) => {
            if (React__default.default.isValidElement(child) && child.type === DynTabPanel) {
              const item = child.props.item;
              const isActive = item?.value === selected;
              return React__default.default.cloneElement(child, { isActive });
            }
            return null;
          }) })
        ]
...
var DynTab = React.forwardRef(
  ({ item, isActive, onSelect, activation = "auto", disabled, className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...props,
      ref,
...
var DynTabPanel = React.forwardRef(
  ({ item, isActive, className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...props,
      ref,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: React__default.default.Children.map(children, (child, index) => {
          if (React__default.default.isValidElement(child) && child.type === DynMenuItem) {
            return React__default.default.cloneElement(child, {
...
var DynMenuItem = React.forwardRef(
  ({
    children,
    disabled = false,
    action,
...
var DynListView = React.forwardRef(
  ({
    items = [],
    selectedItem,
    onSelectionChange,
...
function DynInput({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classNames("dyn-input-wrapper", dataState && `dyn-input--${dataState}`), "data-testid": dataTestId, children: [
    startIcon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "dyn-input__start-icon", children: startIcon }),
    prefix && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "dyn-input__prefix", children: prefix }),
    /* @__PURE__ */ jsxRuntime.jsx(
      As,
      {
        type,
    ...
    suffix && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "dyn-input__suffix", children: suffix }),
    endIcon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "dyn-input__end-icon", children: endIcon })
  ] });
}
function DynButton({
  as: As = "button",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    As,
    {
      ...
      "data-testid": dataTestId,
      children: [
        startIcon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-button__start-icon", children: startIcon }),
        children,
        loading && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-button__loader", "aria-hidden": "true", children: "Loading..." }),
        endIcon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-button__end-icon", children: endIcon })
      ]
    }
  );
}
function DynCheckbox({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dyn-checkbox-wrapper", "data-testid": dataTestId, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        type: "checkbox",
    ...
    label && /* @__PURE__ */ jsxRuntime.jsx("label", { htmlFor: id, className: "dyn-checkbox__label", children: label })
  ] });
}
...
var DynSelect = React.forwardRef(
  ({
    id,
    name,
    value,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: wrapperClasses, "data-testid": dataTestId, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            getDisplayValue(),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-select-trigger__icon", "aria-hidden": "true", children: "\u25BC" })
          ]
        }
      ),
      isOpen && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dyn-select-dropdown", children: [
              ...
              filteredOptions.map((option, index) => {
                ...
                return /* @__PURE__ */ jsxRuntime.jsxs(
                  "li",
                  {
                    ...
                    children: [
                      option.label,
                      option.description && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-select-option__description", children: option.description })
                    ]
                  },
                  option.value
                );
              }),
              filteredOptions.length === 0 && /* @__PURE__ */ jsxRuntime.jsx("li", { className: "dyn-select-option dyn-select-option--empty", children: "No options found" })
            ]
          }
        )
      ] }),
...
var DynTextArea = React.forwardRef(
  ({
    id,
    name,
    value,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: wrapperClasses, "data-testid": dataTestId, children: /* @__PURE__ */ jsxRuntime.jsx(
      "textarea",
      {
        ref,
        id,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "label",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-radio__indicator" }),
          children && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-radio__label", children })
        ]
      }
    );
  }
...
var DynRadioGroup = React.forwardRef(
  ({
    value,
    defaultValue,
    name,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: React__default.default.Children.map(children, (child, index) => {
          if (React__default.default.isValidElement(child) && child.type === DynRadio) {
            const childProps = {
              ...child.props,
...
function DynAvatar({
  ...
  const content = src ? /* @__PURE__ */ jsxRuntime.jsx("img", { src, alt: alt || "", className: "dyn-avatar__image" }) : children ? typeof children === "string" ? generateInitials(children) : children : null;
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      className: cls,
...
var DynTable = React.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { ref: containerRef, className: classNames("dyn-table-container", className), children: /* @__PURE__ */ jsxRuntime.jsxs(
      "table",
      {
        ...props,
        ref,
        ...
        role: "table",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("thead", { children: /* @__PURE__ */ jsxRuntime.jsx("tr", { role: "row", children: columns.map((column) => /* @__PURE__ */ jsxRuntime.jsxs(
            "th",
            {
              role: "columnheader",
              ...
              children: [
                column.label,
                sortable && column.sortable && sortState?.column === column.key && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-table__sort-indicator", children: sortState.direction === "asc" ? "\u2191" : "\u2193" })
              ]
            },
            column.key
          )) }) }),
...
var DynGridItem = React.forwardRef(
  ({
    colSpan,
    rowSpan,
    children,
...
var DynFieldContainer = ({ children }) => /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children });
function DynDivider({
  orientation = "horizontal",
  variant = "solid",
  size = "md",
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      "aria-label": ariaLabel,
      "data-testid": dataTestId,
      children: label && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-divider__label", children: label })
    }
  );
}
...
function DynBreadcrumb({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "nav",
    {
      ...
      "aria-label": ariaLabel,
      "data-testid": dataTestId,
      children: /* @__PURE__ */ jsxRuntime.jsx("ol", { className: "dyn-breadcrumb__list", children: Array.isArray(children) ? children.map((child, index) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "dyn-breadcrumb__item", children: [
        child,
        index < children.length - 1 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-breadcrumb__separator", "aria-hidden": "true", children: separator })
      ] }, index)) : /* @__PURE__ */ jsxRuntime.jsx("li", { className: "dyn-breadcrumb__item", children }) })
    }
  );
}
...
var DynTreeView = React.forwardRef(
  ({
    data = [],
    selectedNode,
    expandedNodes = [],
    ...
    const [internalExpanded, setInternalExpanded] = React.useState(expandedNodes);
    ...
    const renderNode = (node, level = 0) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        ...
        isExpanded && hasChildren && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "dyn-tree-view__children", children: node.children?.map((childNode) => renderNode(childNode, level + 1)) })
      ] }, node.id);
    };
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
...
var DynTreeNode = React.forwardRef(
  ({
    node,
    level = 0,
    expanded,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dyn-tree-node__label", children: node.label })
        ]
      }
    );
  }
...
exports.DYNUI_VERSION = DYNUI_VERSION;
exports.DynAvatar = DynAvatar;
exports.DynBadge = DynBadge;
exports.DynBox = DynBox;
exports.DynBreadcrumb = DynBreadcrumb;
exports.DynBreadcrumbItem = DynBreadcrumbItem;
exports.DynButton = DynButton;
exports.DynCheckbox = DynCheckbox;
exports.DynContainer = DynContainer;
exports.DynDivider = DynDivider;
exports.DynFieldContainer = DynFieldContainer;
exports.DynGrid = DynGrid;
exports.DynGridItem = DynGridItem;
exports.DynIcon = DynIcon;
exports.DynInput = DynInput;
exports.DynListView = DynListView;
exports.DynMenu = DynMenu;
exports.DynMenuItem = DynMenuItem;
exports.DynModal = DynModal;
exports.DynRadio = DynRadio;
exports.DynRadioGroup = DynRadioGroup;
exports.DynSelect = DynSelect;
exports.DynSelectOption = DynSelectOption;
exports.DynStep = DynStep;
exports.DynStepper = DynStepper;
exports.DynTab = DynTab;
exports.DynTabPanel = DynTabPanel;
exports.DynTable = DynTable;
exports.DynTabs = DynTabs;
exports.DynTextArea = DynTextArea;
exports.DynTreeNode = DynTreeNode;
exports.DynTreeView = DynTreeView;
